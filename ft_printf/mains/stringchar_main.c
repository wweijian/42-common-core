...
int main()
{
	...
	// printf("---------------------\nTEST: NULL CHARACTER PRINT\n");
	// printf("printf:\t\t");
	// bytes_written = printf("|%10c|\t\t|%-10c|\n", n1, n1);
	// printf("ft_printf:\t");
	// fflush(stdout);
	// ftbytes_written = ft_printf("|%10c|\t\t|%-10c|\n", n1, n1);
	// printf("\nbytes:    %d\t\tftbytes:  %d\n", bytes_written, ftbytes_written);
	// if (bytes_written != ftbytes_written)
	// 	printf("WRONG BYTES PRINTED\n");
	...
	// printf("\n---------------------\nTEST: STRING PRINT VII (ZERO PRECISION) \n");
	// printf("printf:\t\t");
	// bytes_written = printf("|%2.5s|\t\t|%-2.10s|\n", s3, s3);
	// printf("ft_printf:\t");
	// fflush(stdout);
	// ftbytes_written = ft_printf("|%2.5s|\t\t|%-2.10s|\n", s3, s3);
	// printf("\nbytes:    %d\t\tftbytes:  %d\n", bytes_written, ftbytes_written);
	// if (bytes_written != ftbytes_written)
	// 	printf("WRONG BYTES PRINTED\n");
}