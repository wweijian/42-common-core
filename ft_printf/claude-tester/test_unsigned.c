...
void	test_unsigned_basic(void)
{
	...
	ft_printf("Multiple unsigned: %u %u %u\n", 42, 0, 4242);
...
void	test_unsigned_width(void)
{
	...
	ft_printf("Width 10, zero: '%10u'\n", 0);
	ft_printf("Width 2 (smaller than value): '%2u'\n", 42);
	ft_printf("Width 20: '%20u'\n", 12345);
	ft_printf("Width 20, large value: '%20u'\n", 4294967295u);
	
	// Width with left justification
	ft_printf("Width 10, left-justified: '%-10u'\n", 42);
	ft_printf("Width 10, left-justified, zero: '%-10u'\n", 0);
	ft_printf("Width 20, left-justified: '%-20u'\n", 12345);
	
	// Width with zero padding
	ft_printf("Width 10, zero-padded: '%010u'\n", 42);
	ft_printf("Width 10, zero-padded, zero value: '%010u'\n", 0);
	ft_printf("Width 20, zero-padded: '%020u'\n", 12345);
...
void	test_unsigned_precision(void)
{
	...
	ft_printf("Precision 5, zero: '%.5u'\n", 0);
	ft_printf("Precision 2 (smaller than value): '%.2u'\n", 42);
	ft_printf("Precision 10: '%.10u'\n", 12345);
	
	// Precision 0
	ft_printf("Precision 0, non-zero: '%.0u'\n", 42);
	ft_printf("Precision 0, zero: '%.0u'\n", 0);  // Should print nothing for 0 value
...
void	test_unsigned_width_precision(void)
{
	...
	ft_printf("Width 10, Precision 5, zero: '%10.5u'\n", 0);
	ft_printf("Width 5, Precision 10: '%5.10u'\n", 42);
	ft_printf("Width 10, Precision 0, non-zero: '%10.0u'\n", 42);
	ft_printf("Width 10, Precision 0, zero: '%10.0u'\n", 0);  // Should print 10 spaces
	
	// Width and precision with left justification
	ft_printf("Width 10, Precision 5, left-justified: '%-10.5u'\n", 42);
	ft_printf("Width 10, Precision 5, left-justified, zero: '%-10.5u'\n", 0);
	ft_printf("Width 5, Precision 10, left-justified: '%-5.10u'\n", 42);
...
void	test_unsigned_edge_cases(void)
{
	...
	ft_printf("UINT_MAX with width: '%20u'\n", UINT_MAX);
	ft_printf("UINT_MAX with precision: '%.20u'\n", UINT_MAX);
	ft_printf("UINT_MAX with width and precision: '%25.20u'\n", UINT_MAX);
	
	// Small unsigned value with large precision
	ft_printf("Small value with large precision: '%.30u'\n", 42);
	
	// Zero with different formats
	ft_printf("Zero with width 5: '%5u'\n", 0);
	ft_printf("Zero with precision 5: '%.5u'\n", 0);
	ft_printf("Zero with width 5, precision 0: '%5.0u'\n", 0);
	ft_printf("Zero with width 5, precision 0 (dot only): '%5.u'\n", 0);
...
void	test_unsigned_flag_combinations(void)
{
	...
	ft_printf("Plus flag (should be ignored): '%+u'\n", 42);
	ft_printf("Space flag (should be ignored): '% u'\n", 42);
	
	// Zero flag
	ft_printf("Zero flag with width: '%05u'\n", 42);
	ft_printf("Zero flag with width, zero value: '%05u'\n", 0);
	
	// Zero flag with precision (precision should override zero flag)
	ft_printf("Zero flag with width and precision: '%010.5u'\n", 42);
	
	// Minus flag (left justification)
	ft_printf("Minus flag with width: '%-10u'\n", 42);
	
	// Minus and zero flags together (minus should override zero)
	ft_printf("Minus and zero flags with width: '%-010u'\n", 42);
	
	// Hash flag (should be ignored for unsigned decimal)
	ft_printf("Hash flag (should be ignored): '%#u'\n", 42);
	ft_printf("Hash flag with width (should be ignored): '%#10u'\n", 42);
	ft_printf("Hash flag with precision (should be ignored): '%#.10u'\n", 42);
